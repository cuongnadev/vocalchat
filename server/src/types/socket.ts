...
import type { CallType, CallStatus } from './call';
...
export interface ServerToClientEvents {
  ...
  'call:busy': (payload: { message: string; busyParticipants: string[] }) => void;
  'call:some:busy': (payload: { callId: string; busyParticipants: string[] }) => void;
  ...
  'call:participant:joined': (payload: { callId: string; oderId: string }) => void;
  'call:participant:rejected': (payload: { callId: string; oderId: string }) => void;
